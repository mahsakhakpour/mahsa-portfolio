    ...
    <div className={`project-page ${isDark ? 'dark' : ''}`}>
      ...
      <section className="project-hero">
        <div className="project-container">
          ...
          <p>A full-stack survey platform for collecting and visualizing student preferences for BCIT course platforms. Built with Next.js, TypeScript, and Tailwind CSS, it features real-time data visualization with Recharts, persistent local storage, and a fully responsive design.</p>
